<template>
  <div>
    <nav class="navbar fixed-top navbar-expand-sm scrolling-navbar" v-bind:class="navbarClass"
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        ...
        <ul class="navbar-nav">
          ...
          <router-link :to="{name : 'city'}" tag="li">
            <li class="nav-item">
              <a class="nav-link waves-effect" v-bind:class="brandText">
                Города
              </a>
  ...
  export default {
    ...
    methods: {
      handleScroll(event) {
        if (this.nameComponent !== 'Home') {
          ...
          this.navbarClass = "navbar-light white z-depth-1";
    ...
    computed: {
      ...
      currentClass() {
        ...
        this.navbarClass = this.nameComponent === "Home" ? "transparent-navbar" : "navbar-light white z-depth-1";
