    ...
    <main style="background-color: #f5f6f7;">
      ...
      <section class="container-fluid preview-wrapper">
        <div class="container preview-text">
          ...
          <div class="row">
            <p class="preview-subtitle">Свободный доступ к объявлениям о продаже и аренде объектов недвижимости<br/> по
              всей стране -
        ...
        <div class="category-links-wrapper">
          <div class="row link-list">
            ...
            <div v-for="item in nameTabs">
              <router-link :to="{name : 'objects', params : {tabname : item}}"><span class="link-list-item text-center">{{item}}</span>
              </router-link>
            </div>
          </div>
        </div>
      ...
      <section class="container-fluid main-map-wrapper">
        ...
        <div class="row map-container" data-aos="fade-in"
             ...
             data-aos-duration="1000"
             data-aos-delay="200">
          <l-map ref="map" style="height:inherit; width: inherit; position: absolute; z-index: 0;" :zoom="zoom"
                 :center="center" :options="mapOptions">
      ...
      <section class="container-fluid about-wrapper">
        <div class="container about-text">
          <div class="row pt-3">
            <h2 style="margin-left: auto; margin-right: auto; color:#fff; font-weight: bold;">Открытая недвижимость -
              это:</h2>
          </div>
